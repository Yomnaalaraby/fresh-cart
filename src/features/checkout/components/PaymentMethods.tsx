    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
            ...
            <div className="p-6 space-y-4">
                {/* Cash on Delivery - (Styled as Selected/Active) */}
                {/* Cash on Delivery */}
                <button
                    type="button"
                    className={`w-full p-5 rounded-xl border-2 transition-all flex items-center gap-4 group border-gray-200 hover:border-primary-50`}
                    onClick={() => {
                        changeMethod('cash')
                    }}
                >
                ...
                {/* Online Payment - (Styled as Unselected/Inactive) */}
                {/* Online Payment */}
                <button
                    type="button"
                    className={`w-full p-5 rounded-xl border-2 transition-all flex items-center gap-4 group border-gray-200 hover:border-primary-50`}
                ...
                {/* Security Notice */}
                <div className="flex items-center gap-3 p-4 bg-linear-to-r from-green-50 to-emerald-50 rounded-xl mt-6">
