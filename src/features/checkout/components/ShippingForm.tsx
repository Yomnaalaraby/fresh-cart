                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3.5 pl-14 pr-36 border-2 rounded-xl focus:outline-none transition-all border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-100"
                            {...register("phone")}
                        />
                        <span className="absolute right-4 top-1/2 -translate-y-1/2 text-xs text-gray-400 hidden sm:inline-block">
